        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full h-full">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-slate-300 font-medium max-w-lg leading-relaxed">
              Descubre, vive y gestiona los mejores eventos culturales de
              Lebrija. Tu puerta de entrada a la cultura local.
            </p>
          </div>
          <div className="flex gap-4 text-xs text-slate-400"></div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[40%] min-h-screen min-h-[100dvh] bg-form-bg flex flex-col justify-center items-center overflow-y-auto">
        <div className="w-full max-w-[480px] px-8 py-8 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-3xl font-bold text-midnight-blue tracking-tight">
              Crea tu cuenta
            </h2>
