      ...
      <div className="flex flex-1 min-h-screen w-full flex-col lg:flex-row overflow-hidden">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center p-12">
            <Image src="/logo.png" alt="LebriJaleo" width={96} height={96} className="mb-4 object-contain drop-shadow-lg" priority />
            <h1 className="text-6xl font-black tracking-tighter drop-shadow-lg mb-4 bg-linear-to-br from-[#D4AF37] via-lemon-icing to-[#D4AF37] text-transparent bg-clip-text">
              LEBRIJALEO
            </h1>
        ...
        <div className="flex w-full flex-1 flex-col justify-center bg-form-bg lg:w-[40%] relative">
          ...
          <div className="lg:hidden absolute bottom-0 w-full h-2 bg-linear-to-r from-lemon-icing via-orange-200 to-yellow-200"></div>
        </div>
      </div>
    </div>
  );
